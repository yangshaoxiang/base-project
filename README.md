...
1. [自定义注解实现静态注入](##自定义注解实现静态注入)
2. [自定义注解实现单独 http body 体属性-参数绑定(@RequestBodyParam)](##自定义注解实现单独http的body体属性与参数绑定)
3. [自定义注解实现json结果属性动态过滤](#自定义注解实现json结果属性动态过滤)
